...
\begin{document}
	...
	\textbf{Принцип работы.}  
	Размытие реализовано с помощью \texttt{ImageFilter.GaussianBlur} из Pillow. Гауссово размытие смешивает каждый пиксель с его соседями, используя гауссово распределение: чем ближе соседние пиксели, тем больший вклад они вносят.
	...
	\textbf{Принцип работы.}  
	Фильтр изменяет общую яркость изображения, делая его темнее или светлее.
	...
	\begin{itemize}[noitemsep]
		...
		\item \texttt{factor < 1.0}~--- изображение затемняется.
	\end{itemize}
